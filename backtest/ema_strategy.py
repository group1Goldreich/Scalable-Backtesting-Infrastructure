...
class EmaStrategy(bt.Strategy):
    ...
    def __init__(self):
        ...
        self.emashort = bt.indicators.ExponentialMovingAverage(self.datas[0], period=self.params.short_period)
        self.emalong = bt.indicators.ExponentialMovingAverage(self.datas[0], period=self.params.long_period)
    ...
    def next(self):
        ...
        if not self.position:
            if self.emashort[0] > self.emalong[0]:
...
if __name__ == '__main__':
    cerebro = bt.Cerebro()
    cerebro.addstrategy(EmaStrategy, short_period=15, long_period=200, comm=0.001)
